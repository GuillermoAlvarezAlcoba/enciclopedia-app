...
st.title('Bienvenido a la Enciclopedia Interactiva')

st.header('¡Con esta herramienta conseguirá dominar la geografía Española de una forma más divertida! :sunglasses:')
...
st.markdown("**Comencemos por conocer la situación de España en los relativo a la crisis del Covid-19**")
st.text("Selecciona en el desplegable lo que te interese conocer y empecemos a valorar la situación")
...
st.text("En esta plataforma podras conocer los siguientes datos del lugar seleccionado: ")
st.text("1)Evolución de la población en cuanto a número de habitantes")
st.text("2)Tener una imagen de la bandera del lugar")
st.text("3)Saber cuál es el plato típico (acompañado de una imagen del mismo)")
st.text("4)Conocer el equipo local, así como su año de fundación")
...
if add_selectbox == '1. Evolución de la población':
    ...
    st.text("La provincia a la que pertenece el lugar seleccionado es {}".format(seleccion[0]))
    ...
    st.markdown("El plato típico de la provincia es **{}**".format(seleccion1[0]))
