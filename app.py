...
st.text("1)Evolución de la población en cuanto a número de habitantes :family:")
st.text("2)Tener una imagen de la bandera del lugar :fried_egg:")
st.text("3)Saber cuál es el plato típico (acompañado de una imagen del mismo) :pizza:")
st.text("4)Conocer el equipo local, así como su año de fundación :soccer:")
